...
class FlutterTeam extends employee
{
  ...
  FlutterTeam(this._Department_name,this._Language,this._ID,this._name,this._Years_of_Experience):super( _ID, _name, _Years_of_Experience);
...
//gettrs for the Fluuter_Team attributes
  ...
  void type_Dev()
  { // this method is overrided obligatory due to abstraction
